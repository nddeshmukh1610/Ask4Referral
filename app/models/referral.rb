class Referral < ActiveRecord::Base
	...
	validates :currsalary, presence:true, numericality: true, length: {minimum:1, maximum:10}
	validates :expsalary, presence:true, numericality: true, length: {minimum:1, maximum:10}
	...
	validates :contactemail, presence:true, format: { with: VALID_EMAIL_REGEX }, length: {minimum:6, maximum:15}
